        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            <InfoBadge
              label="Trạng thái"
              value={
                initialProfile.status === "active" ? "Hoạt động" : "Không hoạt động"
              }
              variant={initialProfile.status === "active" ? "success" : "warning"}
            />
            <InfoBadge
              label="Xác thực"
              value={initialProfile.verified ? "Đã xác thực" : "Chưa xác thực"}
              variant={initialProfile.verified ? "success" : "warning"}
            />
            <InfoBadge label="Công ty" value={initialProfile.younet_company} />
            <InfoBadge label="Phòng ban" value={initialProfile.department} />
          </div>
                  ...
                  <div className="rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 divide-y divide-slate-200 dark:divide-slate-700 overflow-hidden">
                    ...
                    <div className="flex justify-between items-center py-3 px-4">
                      ...
                      <span className="font-medium text-slate-900 dark:text-white text-sm">
                        <FormattedDate dateString={initialProfile.last_login} />
                      </span>
                    </div>
                    <div className="flex justify-between items-center py-3 px-4">
                      <span className="text-slate-600 dark:text-slate-400 text-sm">
                      ...
                      >
                        {initialProfile.verified ? "Đã xác thực" : "Chưa xác thực"}
                      </span>
                    </div>
                  </div>
                </div>
